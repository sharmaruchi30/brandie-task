...
class Dimensions {
  ...
  static EdgeInsets commonHorizontalPadding =
  ...
  static double w153 = 153.0.dynamicW;
  static double w160 = 160.0.dynamicW;
  ...
  static double h285 = 285.0.dynamicH;
  ...
  static double sp31 = 31.0.dynamicSP;
  ...
  static double bottomPadding() {
    return buttonHeight() + MediaQuery.of(Get.context!).padding.bottom;
  }
